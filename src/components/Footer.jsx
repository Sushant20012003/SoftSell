          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">
                SoftSell is a fictional software resale startup built to demonstrate responsive, single-page web design, clean code practices, and thoughtful UI/UX decisions. This project is a showcase of fast prototyping and functional design.
              </p>
            </div>
